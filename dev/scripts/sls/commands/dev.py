...
from sls.commands.watch import (
    ChangeAction,
    ChangeClassifier,
    Debouncer,
    Regenerator,
...
from sbs_core.utils import log, SBS_ROOT
...
def cmd_dev(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        log.error("sbs.build.phases not available. Install the sbs package for build support.")
        return 1
