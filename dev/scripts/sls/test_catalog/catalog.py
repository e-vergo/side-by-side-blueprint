...
# CLI commands from sls/cli.py
CLI_COMMANDS = [
    CLICommand("sls archive list", "List archive entries"),
    CLICommand("sls archive tag", "Add tags to an archive entry"),
    CLICommand("sls archive note", "Add or update note on an archive entry"),
    CLICommand("sls archive show", "Show details of an archive entry"),
    CLICommand("sls archive charts", "Generate all charts from unified ledger"),
    CLICommand("sls archive sync", "Sync archive to iCloud"),
    CLICommand("sls archive upload", "Extract Claude data and upload to archive"),
    CLICommand("sls labels list", "Show label taxonomy tree"),
    CLICommand("sls labels sync", "Sync labels to GitHub"),
    CLICommand("sls labels validate", "Validate label names against taxonomy"),
    CLICommand("sls readme-check", "Check which READMEs may need updating"),
    CLICommand("sls test-catalog", "List all testable components"),
    CLICommand("sls watch", "Watch for changes and incrementally regenerate"),
    CLICommand("sls dev", "Dev server with HTTP serving and live reload"),
    CLICommand("sls clean", "Remove build artifacts and caches"),
]
