...
The `sbs-lsp-mcp` server (located at `forks/sbs-lsp-mcp/`) provides 51 tools: 18 Lean tools for proof development and 33 SBS tools for orchestration, testing, archive management, GitHub integration, Zulip search, and self-improve analysis. See the server README for full documentation.
