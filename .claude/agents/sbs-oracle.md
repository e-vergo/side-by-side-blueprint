...
| archive inspection | `forks/sls-mcp/README.md` | Overview |
...
| browser automation | `forks/sls-mcp/README.md` | Overview |
...
| build tools | `forks/sls-mcp/README.md` | Overview |
...
| context generation | `forks/sls-mcp/README.md` | Overview |
...
| debug | `forks/sls-mcp/README.md` | Environment Variables |
...
| do not | `forks/sls-mcp/.pytest_cache/README.md` | pytest cache directory # |
...
| github integration | `forks/sls-mcp/README.md` | Overview |
...
| investigation tools | `forks/sls-mcp/README.md` | Overview |
...
| note: | `forks/sls-mcp/README.md` | Zulip Tools |
...
| oracle querying | `forks/sls-mcp/README.md` | Overview |
...
| question analysis | `forks/sls-mcp/README.md` | Overview |
...
| sls-mcp | `CLAUDE.md` | Repository Map |
...
| self-improve analysis | `forks/sls-mcp/README.md` | Overview |
...
| skill management | `forks/sls-mcp/README.md` | Overview |
...
| testing tools | `forks/sls-mcp/README.md` | Overview |
...
| zulip browsing | `forks/sls-mcp/README.md` | Overview |
