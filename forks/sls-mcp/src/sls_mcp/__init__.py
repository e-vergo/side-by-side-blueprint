...
Strange Loop Station orchestration tooling with Lean LSP integration.
"""

import argparse
import os

from sls_mcp.server import mcp


def main():
    parser = argparse.ArgumentParser(description="SLS MCP Server")
    parser.add_argument(
        "--transport",
        type=str,
    ...
    parser.add_argument(
        "--loogle-cache-dir",
        type=str,
        help="Override loogle cache location (default: ~/.cache/sls-mcp/loogle)",
    )
