...
class SelfImproveContext(BaseModel):
    ...
    Assembled by sls_self_improve() MCP tool based on computed level.
    """
...
class QuestionAnalysisResult(BaseModel):
    """Result from sls_question_analysis."""
...
class QuestionStatsResult(BaseModel):
    """Result from sls_question_stats."""
...
class SkillStatusResult(BaseModel):
    """Result of sls_skill_status query."""
...
class SkillStartResult(BaseModel):
    """Result of sls_skill_start operation."""
...
class SkillTransitionResult(BaseModel):
    """Result of sls_skill_transition operation."""
...
class SkillEndResult(BaseModel):
    """Result of sls_skill_end operation."""
...
class SkillHandoffResult(BaseModel):
    """Result of sls_skill_handoff operation."""
...
class InspectResult(BaseModel):
    """Result from sls_inspect_project."""
...
class TaskResult(BaseModel):
    """Result from sls_task skill tool invocation."""
...
class LogResult(BaseModel):
    """Result from sls_log skill tool invocation."""
...
class QAResult(BaseModel):
    """Result from sls_qa skill tool invocation."""
...
class IntrospectResult(BaseModel):
    """Result from sls_introspect skill tool invocation."""
...
class ConvergeResult(BaseModel):
    """Result from sls_converge skill tool invocation."""
...
class UpdateArchiveResult(BaseModel):
    """Result from sls_update_and_archive skill tool invocation."""
...
class DivinationResult(BaseModel):
    """Result from sls_divination tool invocation."""
