...
class DuckDBLayer:
    ...
    # ------------------------------------------------------------------
    # Analytics methods — replicate sls_self_improve.py logic
    # ------------------------------------------------------------------
    ...
    def analysis_summary(self) -> AnalysisSummary:
        """Replaces ``sls_analysis_summary_impl``."""
        self.ensure_loaded()
        assert self._conn is not None
    ...
    def entries_since_self_improve(self) -> SelfImproveEntries:
        """Replaces ``sls_entries_since_self_improve_impl``."""
        self.ensure_loaded()
        assert self._conn is not None
    ...
    def successful_sessions(self) -> SuccessPatterns:
        """Replaces ``sls_successful_sessions_impl``."""
        self.ensure_loaded()
        assert self._conn is not None
    ...
    def comparative_analysis(self) -> ComparativeAnalysis:
        """Replaces ``sls_comparative_analysis_impl``."""
        self.ensure_loaded()
        assert self._conn is not None
    ...
    def system_health(self) -> SystemHealthReport:
        """Replaces ``sls_system_health_impl``."""
        self.ensure_loaded()
        assert self._conn is not None
    ...
    def user_patterns(self) -> UserPatternAnalysis:
        """Replaces ``sls_user_patterns_impl``."""
        self.ensure_loaded()
        assert self._conn is not None
    ...
    def phase_transition_health(self, as_findings: bool = False) -> PhaseTransitionHealthResult:
        """Replaces ``sls_phase_transition_health_impl``."""
        self.ensure_loaded()
        all_entries = self._get_all_entries_sorted()
        if not all_entries:
    ...
    def interruption_analysis(self, as_findings: bool = False) -> InterruptionAnalysisResult:
        """Replaces ``sls_interruption_analysis_impl``."""
        self.ensure_loaded()
        all_entries = self._get_all_entries_sorted()
        if not all_entries:
    ...
    def gate_failures(self, as_findings: bool = False) -> GateFailureReport:
        """Replaces ``sls_gate_failures_impl``."""
        self.ensure_loaded()
        assert self._conn is not None
    ...
    def tag_effectiveness(self, as_findings: bool = False) -> TagEffectivenessResult:
        """Replaces ``sls_tag_effectiveness_impl``."""
        self.ensure_loaded()
        all_entries = self._get_all_entries_sorted()
        if not all_entries:
    ...
    def question_analysis(
        ...
        """Replaces ``sls_question_analysis_impl``.
    ...
    def question_stats(
        ...
        """Replaces ``sls_question_stats_impl``."""
        self.ensure_loaded()
