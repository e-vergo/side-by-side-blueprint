...
- sls_introspect: Introspection and self-improvement (L2 and L3+)
...
class TestUpdateArchiveResultModel:
    ...
    def test_porcelain_result(self) -> None:
        ...
        result = UpdateArchiveResult(
            ...
            repos_committed=["Dress", "Runway", "sls-mcp"],
        )
...
class TestGateSpecParsing:
    ...
    def test_parse_simple_gate_spec(self) -> None:
        ...
        from sls_mcp.gate_validation import parse_gate_spec_from_plan
...
class TestGateResult:
    ...
    def test_gate_result_all_pass(self) -> None:
        ...
        from sls_mcp.gate_validation import GateResult
...
class TestTypeInference:
    ...
    def test_infer_bug_visual(self) -> None:
        ...
        from sls_mcp.skill_tools import _infer_type_label
...
class TestAreaInference:
    ...
    def test_infer_sbs_graph_area(self) -> None:
        ...
        from sls_mcp.skill_tools import _infer_area_labels
...
# =============================================================================
# sls_task Phase Tests
# =============================================================================


class TestTaskPhases:
    """Tests for sls_task phase transitions."""
...
class TestQAPhases:
    """Tests for sls_qa phase transitions."""
...
# =============================================================================
# sls_introspect Level Dispatch Tests
# =============================================================================
...
# =============================================================================
# sls_update_and_archive Phase Tests
# =============================================================================
...
# =============================================================================
# sls_divination Tests
# =============================================================================


class TestDivination:
    """Tests for sls_divination codebase exploration."""
