...
class TestLastScreenshot:
    ...
    def test_computes_hash(self, mock_archive_dir: Path) -> None:
        ...
        from sls_mcp.sls_utils import compute_hash
...
class TestVisualHistory:
    """Tests for sls_visual_history tool."""

    def test_returns_history(self, mock_archive_dir: Path) -> None:
        """Returns history of screenshots."""
        from sls_mcp.sls_models import HistoryEntry, VisualHistoryResult
    ...
    def test_detects_changes(self) -> None:
        ...
        from sls_mcp.sls_models import HistoryEntry
...
class TestEntryIdConversion:
    ...
    def test_entry_id_to_dir_format(self) -> None:
        ...
        from sls_mcp.sls_tools import _entry_id_to_dir_format
    ...
    def test_dir_format_to_entry_id(self) -> None:
        ...
        from sls_mcp.sls_tools import _dir_format_to_entry_id
    ...
    def test_roundtrip_conversion(self) -> None:
        ...
        from sls_mcp.sls_tools import _dir_format_to_entry_id, _entry_id_to_dir_format
