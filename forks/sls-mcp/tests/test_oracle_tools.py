...
from sls_mcp.sls_models import AskOracleResult, OracleConcept, OracleMatch
...
class TestLegacyOracleQueryResult:
    """Tests for the legacy OracleQueryResult model (still in sls_models)."""

    def test_legacy_model_exists(self) -> None:
        """OracleQueryResult still exists for backward compatibility."""
        from sls_mcp.sls_models import OracleQueryResult
