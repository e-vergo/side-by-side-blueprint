...
from sbs_lsp_mcp.models import LoogleResult
...
def get_cache_dir() -> Path:
    ...
    return Path(xdg) / "sbs-lsp-mcp" / "loogle"
...
class LoogleManager:
    ...
    Args:
        cache_dir: Directory for loogle repo and indices (default: ~/.cache/sbs-lsp-mcp/loogle)
