...
class TestRunTests:
    ...
    def test_extracts_failures(self, sample_failing_output: str) -> None:
        ...
        from sbs_lsp_mcp.sbs_tools import _extract_failures
    ...
    def test_respects_filter(self) -> None:
        ...
        from sbs_lsp_mcp.sbs_models import TestResult
...
class TestBuildProject:
    ...
    def test_extracts_build_run_id(self) -> None:
        ...
        from sbs_lsp_mcp.sbs_tools import _extract_build_run_id
...
class TestServeProject:
    """Tests for sbs_serve_project tool."""

    def test_serve_result_structure(self) -> None:
        """ServeResult has correct structure."""
        from sbs_lsp_mcp.sbs_models import ServeResult
