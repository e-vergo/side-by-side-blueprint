...
class TestEpochSummary:
    """Tests for sbs_epoch_summary tool."""
    ...
    def test_aggregates_visual_changes(
        ...
        from sbs_lsp_mcp.sbs_models import VisualChange
    ...
    def test_specific_epoch_id(
        ...
        from sbs_lsp_mcp.sbs_models import EpochSummaryResult
...
class TestContext:
    """Tests for sbs_context tool."""

    def test_includes_state_section(
        self, mock_archive_index: Dict[str, Any]
    ) -> None:
        """Context includes state when requested."""
        from sbs_lsp_mcp.sbs_models import ContextResult
...
class TestArchiveEntryModel:
    ...
    def test_summary_from_entry(
        ...
        from sbs_lsp_mcp.sbs_models import ArchiveEntrySummary
